 ...
 * @LastEditTime: 2021-09-25 14:08:29
 * @LastEditors: Qun
 * @Description:
 * @FilePath: \vue-demo\src\data\examData1.js
 *
 */
/**
...
export const examList = [
  ...
  {
    title:
      "五年一班在上学期期末检测时，有2名学生不及格，及格率是95﹪，五年一班共有学生（ ）名",
    options: ["35", "50", "40", "60"],
    answer: 2,
    score: 10,
    examId: "3"
  ...
  {
    title:
      "甲、乙两车早晨8点分别从两城市出发，相向而行，到下午1点在途中相遇。已知甲车平均每小时行100千米，乙车平均每小时行98千米，那么这两个城市之间的路程是多少千米？",
